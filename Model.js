...
// Add this to your Model.js file
...
const Payment = sequelize.define('Payment', {
  ...
  order_id: {
    type: DataTypes.INTEGER,
    references: {
      model: Order,  // Foreign key to 'Order' model
      key: 'order_id',
    },
    allowNull: false,
  },
  ...
  // Model options
  timestamps: true,
  tableName: 'Payment',  // Table name in the database
});

// Define relationships between Payment and Order
Order.hasOne(Payment, { foreignKey: 'order_id' });
Payment.belongsTo(Order, { foreignKey: 'order_id' });

// Update exports to include Payment model
...
Menu:Menu, Restaurants:Restaurants, Order: Order, Payment: Payment};
